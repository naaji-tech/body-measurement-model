...
STANDARD_LABELS = {
    ...
    "shoulderToCrotchHeight": "shoulder to crotch height",
    ...
    "calfCircumference": "calf left circumference",
    "ankleCircumference": "ankle left circumference",
...
class SMPLMeasurementDefinitions:
    ...
    LENGTHS = {
        "height": (SMPL_LANDMARK_INDICES["HEAD_TOP"], SMPL_LANDMARK_INDICES["HEELS"]),
